<template>
  <div class="max-w-md mx-auto mt-6">
    <h2 class="text-2xl font-semibold mb-4">{{ isEditing ? 'Edit Project' : 'Create New Project' }}</h2>
    <form @submit.prevent="handleSubmit">
      ...
      <div class="mb-4">
        ...
        <textarea v-model="projectData.description" id="description"
          class="w-full border rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" rows="3"
          required></textarea>
      </div>
